...
stock GiveGiantPyro(client)
{
	if (IsValidClient(client))
	{
		...
		if(IsValidEntity(Weapon1))
		{
			...
			TF2Attrib_SetByName(Weapon1, "projectile speed decreased", 0.70);
			TF2Attrib_SetByName(Weapon1, "killstreak tier", 1.0);			
...
\			
		...
		if(IsValidEntity(Weapon2))
		{
			...
			TF2Attrib_SetByName(Weapon2, "speed buff ally", 5.0);
/* 			TF2Attrib_SetByName(Weapon2, "melee range multiplier", 2.45);
			TF2Attrib_SetByName(Weapon2, "melee_bounds_multiplier", 2.3); */
		}
	}
}
