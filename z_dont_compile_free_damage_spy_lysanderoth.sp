...
#define ROBOT_NAME	"Lysanderbot"
#define ROBOT_ROLE "Damage"
#define ROBOT_CLASS "Spy"
#define ROBOT_SUBCLASS "Hitscan"
#define ROBOT_DESCRIPTION "King Dragon sends his regards"
...
stock GiveBigRoboDane(client)
{
	...
	CreateRoboHat(client, Powdered, 10, 6, 8208497.0, 1.1, -1.0); 
	CreateRoboHat(client, Rogue, 10, 6, 8208497.0, 1.0, 0.0);
	CreateRoboHat(client, Dictator, 10, 6, 0.0, 1.15, -1.0);
