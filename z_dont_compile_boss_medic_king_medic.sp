...
#define ROBOT_NAME	"King Medic"
#define ROBOT_ROLE "ZBOSS"
#define ROBOT_DESCRIPTION "King Rune"
#define ROBOT_ON_DEATH "KING!"
...
#define ClassCrown 30808
#define MedicalMonarch 30750
...
stock GiveGiantMedic(client)
{
	if (IsValidClient(client))
	{
		...
		CreateRoboHat(client, ClassCrown, 10, 6, 0.0, 1.0, -1.0);
		CreateRoboHat(client, MedicalMonarch, 10, 6, 0.0, 1.0, -1.0);
		
		CreateRoboWeapon(client, "tf_weapon_medigun", 211, 9, 1, 2, 0);
		...
		if(IsValidEntity(Weapon2))
		{
			...
			TF2Attrib_SetByName(Weapon2, "is australium item", 1.0);
			...
			// TF2CustAttr_SetString(Weapon2,"medigun charge is nothing", "");
			TF2CustAttr_SetString(Weapon2,"medigun charge is nothing", "cond=109");
