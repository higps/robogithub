...
#define ROBOT_NAME	"Demoknight"
#define ROBOT_ROLE "Basic"
#define ROBOT_DESCRIPTION "Eyelander Demoknight"
...
//	 PrintToChatAll("iHealth %i", iHealth);
	...
	TF2Attrib_SetByName(client, "airblast vulnerability multiplier", 2.5);
	...
	PrintHintText(client , "Long Charge\nHigh Impact Damage\n3 second crit boost on kill with Eyelander\nHigh Jumps");
...
stock GiveGiantDemoKnight(client)
{
	if (IsValidClient(client))
	{
		...
		CreateRoboHat(client, Prince, 10, 6, 0.0, 0.75, 1.0); 
