...
#define ROBOT_NAME	"Plague"
#define ROBOT_ROLE "Damage"
#define ROBOT_DESCRIPTION "Medigun deals damage"
...
MakeGiantMedic(client)
{
	...
	PrintHintText(client , "Use your evil medigun to hurt the enemy team");
...
stock GiveGiantMedic(client)
{
	if (IsValidClient(client))
	{
		...
		CreateRoboWeapon(client, "tf_weapon_medigun", 594, 6, 1, 1, 0);
		
		CreateRoboHat(client, BytedBeak, 10, 6, 0.0, 1.0, -1.0); 
