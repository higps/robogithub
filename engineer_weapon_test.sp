...
{
	name = "[TF2] Hit Players with wrangler",
	author = "HiGPS",
	description = "Hit Players with wrangler",
	version = "1",
...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_givewrangler", MakeTestWeapon, ADMFLAG_ROOT, "Get the experimental wrangler");
...
public Action MakeTestWeapon(int client, int args)
{
		...
		CreateTestWeapon(client, "tf_weapon_laser_pointer", 7, 6, 1, 2, 0);
		...
		if(IsValidEntity(Weapon2))
		{
			...
			//TF2Attrib_SetByName(Weapon2, "uber duration bonus", 3.0);
