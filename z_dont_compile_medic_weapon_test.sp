...
{
	name = "[TF2] Testing Medigun for Creators.TF",
	author = "HiGPS",
	description = "Medigun with AOE uber",
	version = "1",
...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_givemedigun", MakeTestWeapon, ADMFLAG_ROOT, "Get the experimental medigun");
