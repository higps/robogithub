...
public OnPluginStart()
{
	...
	PipeCount = CreateConVar("boss_clusterbomb_count", "5", "Number of child grenades to spawn from a clusterbomb");
	PipeDamage = CreateConVar("boss_clusterbomb_damage", "250", "Percentage of parent grenade's damage that child grenades should deal");
