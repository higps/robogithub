...
stock GiveBigRoboDane(client)
{
	if (IsValidClient(client))
	{
		...
		if(IsValidEntity(Weapon3))
		{
			...
			TF2CustAttr_SetString(Weapon3, "robot engineer", "sentry_scale=1.25 dispenser_scale=1.25 infinite_ammo=1 sentries=5 dispensers=3 remove_all_sappers=1 yeet=0");
