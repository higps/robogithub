...
#define ROBOT_NAME	"Right Click Homer"
...
TF2Attrib_SetByName(client, "health from packs decreased", HealthPackPickUpRate);
	...
	PrintCenterText(client, "Use +attack2 / MOUSE2 to redirect rockets");
...
//		CreateWeapon(client, "tf_weapon_shovel", 447, 6, 1, 2, 0);
		...
		CreateRoboHat(client, GATEBOT, 10, 6, 0.0, 0.75, -1.0); //Gatebot
