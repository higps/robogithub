...
#define ROBOT_NAME	"Dr GrordBot Mk II"
#define ROBOT_ROLE "Support"
#define ROBOT_DESCRIPTION "Bison"
#define ROBOT_SPAWNTIP "You have fire bison"
...
//		CreateWeapon(client, "tf_weapon_shovel", 447, 6, 1, 2, 0);
		...
		if(IsValidEntity(Weapon1))
		{
			...
			TF2Attrib_SetByName(Weapon1, "dmg penalty vs players", 3.0);
		...
		//	TF2Attrib_SetByName(Weapon1, "clipsize increase on kill", 4.0);		
			TF2Attrib_SetByName(Weapon1, "clip size bonus upgrade", 3.0);
