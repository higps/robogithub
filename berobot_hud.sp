...
{
    int teamResources = GetTeamResource(team);
    SetHudTextParams(-1.0, 0.75, 4.0, r, g, b, a, 0, 0.0, 0.0, 0.0);
    for(int i = 1; i <= MaxClients; i++)
    {
        ...
        ShowSyncHudText(i, _hudSynchronizer, "team-resources: %i", teamResources);
    }
}